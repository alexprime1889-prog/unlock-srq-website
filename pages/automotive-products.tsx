...
export default function AutomotiveProductsPage() {
  ...
  return (
    <>
      <Head>
        <title>Automotive Products & Accessories | Car Keys, FOBs, Batteries | North Port FL</title>
        <meta name="description" content="High-quality automotive locksmith products in North Port, Port Charlotte, Punta Gorda FL. Transponder keys, smart keys, key FOBs, car batteries, ignition parts. Expert installation available. Call (941) 587-5050" />
        <meta name="keywords" content="automotive products North Port, car keys Port Charlotte, key FOBs Punta Gorda, transponder keys Venice FL, car batteries Charlotte County, smart keys, ignition parts, locksmith products Florida" />
        <meta name="author" content="Unlock SRQ LLC" />
        
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://srqunlock.com/automotive-products" />
        <meta property="og:title" content="Automotive Products & Accessories | Car Keys, FOBs, Batteries | North Port FL" />
        <meta property="og:description" content="High-quality automotive locksmith products in North Port, Port Charlotte, Punta Gorda FL. Transponder keys, smart keys, key FOBs, car batteries, ignition parts." />
        ...
        <meta property="og:image:alt" content="Professional automotive locksmith Maksim Yepikhin with car keys and products" />
        <meta property="og:image:type" content="image/webp" />
        
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Automotive Products & Accessories | Car Keys, FOBs, Batteries | North Port FL" />
        <meta name="twitter:description" content="High-quality automotive locksmith products in North Port, Port Charlotte, Punta Gorda FL. Transponder keys, smart keys, key FOBs, car batteries." />
        ...
        <link rel="canonical" href="https://srqunlock.com/automotive-products" />
