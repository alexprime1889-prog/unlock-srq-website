...
export default function PortCharlottePage() {
  ...
  return (
    <>
      <Head>
        <title>{portCharlotteConfig.title}</title>
        <meta name="description" content={portCharlotteConfig.description} />
        <meta name="keywords" content="locksmith Port Charlotte, Port Charlotte locksmith, emergency locksmith Port Charlotte FL, car locksmith Charlotte County, residential locksmith, commercial locksmith, key programming Port Charlotte, 24/7 locksmith Florida" />
        <meta name="author" content="Maksim Yepikhin - Unlock SRQ LLC" />
        <meta name="robots" content="index, follow" />
        
        <meta name="geo.region" content="US-FL" />
        <meta name="geo.placename" content="Port Charlotte" />
        <meta name="geo.position" content="26.9762;-82.0906" />
        <meta name="ICBM" content="26.9762, -82.0906" />
        
        <link rel="canonical" href={`https://srqunlock.com/${portCharlotteConfig.slug}/`} />
        
        <meta property="og:title" content={portCharlotteConfig.title} />
        <meta property="og:description" content={portCharlotteConfig.description} />
        <meta property="og:url" content={`https://srqunlock.com/${portCharlotteConfig.slug}/`} />
        ...
        <meta property="og:image:alt" content="Professional locksmith Maksim Yepikhin serving Port Charlotte FL" />
        <meta property="og:image:type" content="image/webp" />
        <meta property="og:type" content="website" />
        
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={portCharlotteConfig.title} />
        <meta name="twitter:description" content={portCharlotteConfig.description} />
