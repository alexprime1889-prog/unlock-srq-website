...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Automotive Locksmith Services | Car Key Programming North Port FL",
    description: "Professional automotive locksmith services in North Port, Port Charlotte, Punta Gorda FL. Car key programming, transponder keys, smart keys, ignition repair, emergency car lockout. 24/7 mobile service. Call (941) 587-5050",
    keywords: "automotive locksmith North Port, car key programming Port Charlotte, transponder key Punta Gorda, smart key Venice FL, car lockout Charlotte County, ignition repair, emergency car locksmith, mobile automotive locksmith Florida",
    authors: [{ name: "Unlock SRQ LLC" }],
    openGraph: {
      type: "website",
      url: "https://srqunlock.com/automotive-services",
      title: "Automotive Locksmith Services | Car Key Programming North Port FL",
      description: "Professional automotive locksmith services in North Port, Port Charlotte, Punta Gorda FL. Car key programming, transponder keys, smart keys, ignition repair, emergency car lockout. 24/7 mobile service.",
      ...
      images: [{
        ...
        width: 1920,
        height: 1280,
        alt: "Professional automotive locksmith Maksim Yepikhin mobile workshop with car key programming equipment",
        type: "image/webp"
      }]
    },
    twitter: {
      ...
      title: "Automotive Locksmith Services | Car Key Programming North Port FL",
      description: "Professional automotive locksmith services in North Port, Port Charlotte, Punta Gorda FL. Car key programming, transponder keys, smart keys, ignition repair.",
    ...
    robots: "index, follow",
    alternates: {
      canonical: "https://srqunlock.com/automotive-services"
    }
  };
}
